...
import { useIsMobile } from "@/hooks/use-mobile" // I'll need to create this hook or simplify it
...
const SidebarProvider = React.forwardRef((
  ...
  // We add a state so that we can use it as a data-attribute on the handler.
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[side=left]:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow md:peer-data-[variant=inset]:border",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Increases the visibility of the action on hover
...
const SidebarMenuSkeleton = React.forwardRef(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="h-4 flex-1 rounded-md bg-sidebar-foreground/10"
